...
static char *MakeProfileReport(WeChatProfile *payload)
{
    ...
    cJSON_AddStringToObject(reported, payload->reportAction.subDeviceActionTemperature,
...
#define CN_PROFILE_TOPICFMT_TOPIC            "$shadow/operation/S1G37FM98Y/Hi3861_mqtt"
